...
# Skip entire module when running a different SITE to reduce noise
if (os.getenv("SITE") or "ratemate").strip().lower() != SITE_KEY:
    pytest.skip("Different site", allow_module_level=True)
